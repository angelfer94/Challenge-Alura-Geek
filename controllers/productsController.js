...
export const nuevoProducto = (name, price, imageUrl, id) => {
    const contenido = `
             <div class="product__card-edit hidden ">
                ...
                <a href="../screens/edit-product?id=${id}"><img src="../images/icons/edit.svg" alt="edition_icon" class="iconEdit" data-edit></a>
            </div>
...
const productos2 = document.querySelector('[data-smartwatchCategoria]');
const productos3 = document.querySelector('[data-accesoriosCategoria]');
